      ...
      <section id="form">
        ...
        {isFileInput ? (
          <form onSubmit={handleFileSubmit}>
            ...
            <button
              className="mt-6 relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-md font-medium rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white text-onBackground focus:ring-4 focus:outline-none focus:ring-green-800"
              type="submit"
              disabled={isLoading}
            >
              {isLoading ? (
