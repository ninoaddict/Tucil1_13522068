    ...
    <>
      <form onSubmit={handleFileSubmit}>
        <div className="flex items-center justify-center w-full">
          <label
            htmlFor="txt-file"
            className="flex flex-col items-center justify-center w-full h-56 md:h-64 border-2 border-dashed rounded-lg cursor-pointer hover:bg-bray-800 bg-gray-700 border-gray-600 hover:border-gray-500 hover:bg-gray-600"
          >
