    ...
    <>
      <form onSubmit={handleFileSubmit}>
        <div className="flex items-center justify-center w-full">
          <label
            htmlFor="txt-file"
            className="flex flex-col items-center justify-center w-full h-56 md:h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer dark:hover:bg-bray-800 bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
          >
